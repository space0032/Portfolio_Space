...
export const WAYPOINTS: SectionWaypoint[] = [
  { at: 0.0, camera: [0, 0, 12], lookAt: [0, 0, 0], color: "#d4af6a", distort: 0.3, orbRadius: 0.9, orbSpeed: 0.4, starSpeed: 0.5 },
  { at: 0.16, camera: [5.5, 2.2, 8], lookAt: [0, 0, 0], color: "#9b7fe0", distort: 0.42, orbRadius: 1.1, orbSpeed: 0.6, starSpeed: 0.8 },
  { at: 0.33, camera: [-5.5, 3.2, 8.5], lookAt: [0, 0, 0], color: "#f0cd8a", distort: 0.58, orbRadius: 1.4, orbSpeed: 0.75, starSpeed: 1.0 },
  { at: 0.5, camera: [0, 5.2, 9.5], lookAt: [0, 0, 0], color: "#c15b4a", distort: 0.38, orbRadius: 1.05, orbSpeed: 0.5, starSpeed: 0.6 },
  { at: 0.66, camera: [7.5, 0.8, 6.5], lookAt: [0, 0, 0], color: "#b79df0", distort: 0.52, orbRadius: 1.3, orbSpeed: 0.7, starSpeed: 1.1 },
  { at: 0.84, camera: [0, -2.5, 14.5], lookAt: [0, 0, 0], color: "#d4af6a", distort: 0.24, orbRadius: 0.85, orbSpeed: 0.35, starSpeed: 0.4 },
];

export const TECHS: { name: string; color: string }[] = [
  { name: "Java", color: "#d4af6a" },
  { name: "React", color: "#f0cd8a" },
  { name: "TypeScript", color: "#9b7fe0" },
  { name: "Docker", color: "#b79df0" },
  { name: "AWS", color: "#d4af6a" },
  { name: "Git", color: "#c15b4a" },
  { name: "Node.js", color: "#f0cd8a" },
  { name: "Spring Boot", color: "#9b7fe0" },
];
